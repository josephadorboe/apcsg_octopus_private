<?php
	...
	$setupdevicepricemodel = htmlspecialchars(isset($_POST['setupdevicepricemodel']) ? $_POST['setupdevicepricemodel'] : '');
	$dept = 'OPD';
	Global $instcode;
	
	// 20 DEC 2023 JOSEPH ADORBOE  
	switch ($setupdevicepricemodel)
	{

		// 2 DEC 2023 JOSPH ADORBOE
		case 'editdevicesprices':
		...
		case 'changedevicesprices':
			...
			if($preventduplicate == '1'){
				...
				//	$alternateprice = $cashprice;
					...
					$sqlresults = $devicesetuptable->updatedevicesprices($itemcode,$costprice,$cashprice,$stockvalue,$partnerprice,$alternateprice,$dollarprice,$insuranceprice,$instcode);			
					$action = "Change Device Price";
					if($sqlresults =='2'){
						$stockadjustmenttable->pricechangesstockadjustment($ajustcode,$adjustmentnumber,$days,$itemcode,$itemnumber,$item,$totalqty,$cashprice,$costprice,$insuranceprice,$dollarprice,$unit,$currentshift,$currentshiftcode,$type,$currentuser,$currentusercode,$instcode);	
