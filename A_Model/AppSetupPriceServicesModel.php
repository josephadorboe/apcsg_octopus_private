<?php
	...
	$setupservicepricemodel = htmlspecialchars(isset($_POST['setupservicepricemodel']) ? $_POST['setupservicepricemodel'] : '');
	$dept = 'OPD';
	Global $instcode;
	
	// 28 NOV 2023 JOSEPH ADORBOE  
	switch ($setupservicepricemodel)
	{

		// 28 NOV 2023 JOSPH ADORBOE
		case 'editserviceprices':
		...
		case 'servicechangeprices':
			...
			if($preventduplicate == '1'){
				if(empty($ekey) || empty($cashprice) ){
					...
					$cash = 'CASH';
					$sqlresults = $adminservicetable->changeserviceprice($itemcode,$cashprice,$alternateprice,$dollarprice,$insuranceprice,$instcode);									
