 <?php
	...
	$patientprocedureprocessingmodel = htmlspecialchars(isset($_POST['patientprocedureprocessingmodel']) ? $_POST['patientprocedureprocessingmodel'] : '');
	
	// 23 NOV 2023
switch ($patientprocedureprocessingmodel)
{
	...
	case 'patientprocedureprocessingreturnprocedures':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');
	...
	// 1 Oct 2024, JOSEPH ADORBOE
	case 'patientprocedureprocessingmanageeditprocedurerequest':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');
		$visitcode = htmlspecialchars(isset($_POST['visitcode']) ? $_POST['visitcode'] : '');
	...
	// 1 OCT 2024, JOSEPH ADORBOE
	case 'patientprocedureprocessingunarchiveprocedure':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');						
		$preventduplicate = $userformlogtable->checkformactionkey($form_number,$form_key,$currentusercode);
		if($preventduplicate == '1'){		
			if($currentshiftcode == '0'){				
				...
				if(empty($_POST["scheckbox"])){   
					...
					foreach($_POST["scheckbox"] as $key){						
							$kt = explode('@@@',$key);
							$ekey = $kt['0'];
							$sqlresults = $patientproceduretable->unarchiveprocedure($ekey,$days,$currentuser,$currentusercode,$instcode);
							
							$action = "UnArchive procedure";
							$result = $engine->getresults($sqlresults,$item='',$action);
							$re = explode(',', $result);
							$status = $re[0];					
							$msg = $re[1];
	...
	break;
	// 1 OCT 2024, JOSEPH ADORBOE
	case 'patientprocedureprocessingbulkprocedurearchive':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');						
		$preventduplicate = $userformlogtable->checkformactionkey($form_number,$form_key,$currentusercode);
		if($preventduplicate == '1'){		
	...
	break;
	// 28 SEPT 2024,  JOSEPH ADORBOE
	case 'patientprocedureprocessingsaveprocedurereport':		
		$form_number = isset($_POST['form_number']) ? $_POST['form_number'] : '';
		$form_key = isset($_POST['form_key']) ? $_POST['form_key'] : '';
		$ekey = isset($_POST['ekey']) ? $_POST['ekey'] : '';
		$procedurecode = isset($_POST['procedurecode']) ? $_POST['procedurecode'] : '';
	...
	// 25 SEPT 2024,   13 FEB 2022  JOSEPH ADORBOE
	case 'patientprocedureprocessingsaveprocedurenotes':		
		$form_number = isset($_POST['form_number']) ? $_POST['form_number'] : '';
		$form_key = isset($_POST['form_key']) ? $_POST['form_key'] : '';
		$ekey = isset($_POST['ekey']) ? $_POST['ekey'] : '';
		$procedurecode = isset($_POST['procedurecode']) ? $_POST['procedurecode'] : '';
	...
	case 'patientprocedureprocessingsendforpayment':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');
		$visitcode = htmlspecialchars(isset($_POST['visitcode']) ? $_POST['visitcode'] : '');
		$patientcode = htmlspecialchars(isset($_POST['patientcode']) ? $_POST['patientcode'] : '');
	...
	// 25 SEPT 2024, 23 NOV 2023 JOSEPH ADORBOE
	case 'patientprocedureprocessingunselecttransaction':
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');
		$visitcode = htmlspecialchars(isset($_POST['visitcode']) ? $_POST['visitcode'] : '');
		$patientcode = htmlspecialchars(isset($_POST['patientcode']) ? $_POST['patientcode'] : '');
	...
	// 25 SEPT 2024, 23 NOV 2023 JOSEPH ADORBOE
	case 'patientprocedureprocessingselecttransaction':		
		$form_number = htmlspecialchars(isset($_POST['form_number']) ? $_POST['form_number'] : '');
		$form_key = htmlspecialchars(isset($_POST['form_key']) ? $_POST['form_key'] : '');
		$visitcode = htmlspecialchars(isset($_POST['visitcode']) ? $_POST['visitcode'] : '');
		$patientcode = htmlspecialchars(isset($_POST['patientcode']) ? $_POST['patientcode'] : '');
