<?php
	...
	$setupimagingpricemodel = htmlspecialchars(isset($_POST['setupimagingpricemodel']) ? $_POST['setupimagingpricemodel'] : '');
	$dept = 'OPD';
	Global $instcode;
	
	// 29 NOV 2023 JOSEPH ADORBOE  
	switch ($setupimagingpricemodel)
	{

		// 29 NOV 2023 JOSPH ADORBOE
		case 'editimagingprices':
		...
		case 'imagingchangeprices':
			...
			if($preventduplicate == '1'){
				...
				//	$alternateprice = $partnerprice;
					$alternateprice = 0;
					$cashpricecode = md5(microtime());	
					$cash = 'CASH';
					$sqlresults = $setupradiologytable->updateimagingprices($ekey,$cashprice,$alternateprice,$dollarprice,$partnerprice,$insuranceprice,$currentuser,$currentusercode,$instcode);									
					$action = "Change Imaging Price";
					if($sqlresults =='2'){							
