...
if ($details) {
	...
	public function getpatientgenderstatsreport($instcode){
		...
		return $totalpatients.'@'.$totalmalepatients.'@'.$totalfemalepatients.'@'.$totalchildrenpatients.'@'.$totaladultpatients.'@'.$totalelderlypatients.'@'.$totalmalechildrenpatients.'@'.$totalfemalechildrenpatients.'@'.$totaladultmalepatients.'@'.$totaladultfemalepatients.'@'.$totaleldermalepatients.'@'.$totalelderfemalepatients;
	//	return $totalchildrenpatients;
	...
	// 10 SEPT 2021    JOSEPH ADORBOE
	public function currentmonth($currentday,$currentmonth,$currentyear,$currentuser,$currentusercode,$instcode){	
		$bt = 2;
		$sqlstmt = ("SELECT ST_ID FROM octopus_st_summary where ST_NAME = ? and ST_INSTCODE =? and ST_TYPE = ? ");
		$st = $this->db->prepare($sqlstmt);   
	...
	// 10 SEPT 2021   JOSEPH ADORBOE
	public function currentyear($currentday,$currentmonth,$currentyear,$currentuser,$currentusercode,$instcode){	
