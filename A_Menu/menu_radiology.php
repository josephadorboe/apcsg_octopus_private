	...
	<div class="tab-content">
			...
			<div class="tab-pane <?php   if($sub == 1){ ?> active  <?php  }  ?> " id="index13a">
				<ul class="side-menu toggle-menu">
					...
					<li>
						<a class="side-menu__item" href="radiology__managerequest"><i class="side-menu__icon typcn typcn-shopping-bag"></i><span class="side-menu__label">Manage Request</span> <?php if($radiologycount > 0){ ?> <span class="badge badge-primary"><?php echo $radiologycount ; ?></span> <?php } ?></a>
					</li>	
					<li>
						<a class="side-menu__item" href="radiology__resultarchive"><i class="side-menu__icon typcn typcn-database" data-toggle="tooltip"> </i> <span class="side-menu__label"> Result Archive</span></a>
					</li>	
					<li>
